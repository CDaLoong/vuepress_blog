...
<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644805621879-92af74f3-419b-47d0-9e1b-bda51362717b.png#averageHue=%239d9bb1&clientId=u6524202e-5462-4&from=paste&height=618&id=ud191392a&name=image.png&originHeight=618&originWidth=890&originalType=binary&ratio=1&rotation=0&showTitle=false&size=55211&status=done&style=none&taskId=u04b8f3c8-4004-45c6-8368-2d68f03bdbf&title=&width=890) -->
### 背景
...
<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644806459473-7a946076-398e-4e9f-81dd-f9def4403d97.png#averageHue=%23a8bde3&clientId=u6524202e-5462-4&from=paste&height=314&id=ua052515b&name=image.png&originHeight=314&originWidth=1137&originalType=binary&ratio=1&rotation=0&showTitle=false&size=44613&status=done&style=none&taskId=udcefe5b4-7df6-41c3-9643-add6c67a8cf&title=&width=1137) -->
npm 安装一个包，分为两种安装方式：
...
<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644806957197-270aff05-5bf5-44ed-abbc-343d48c74723.png#averageHue=%23d4def1&clientId=u6524202e-5462-4&from=paste&height=549&id=u357e1606&name=image.png&originHeight=549&originWidth=818&originalType=binary&ratio=1&rotation=0&showTitle=false&size=31575&status=done&style=none&taskId=u73b8d2fa-a259-4aa1-8294-c84e9264a43&title=&width=818) -->
...
### 开源协议
<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644807354055-2a03fea9-4fb8-4589-8191-34b3d3d02a63.png#averageHue=%23fbfefa&clientId=u6524202e-5462-4&from=paste&height=416&id=ud6013b5b&name=image.png&originHeight=416&originWidth=1200&originalType=binary&ratio=1&rotation=0&showTitle=false&size=118555&status=done&style=none&taskId=uf9bed4d7-5710-4b4a-a2ab-9f7abc596e7&title=&width=1200) -->
...
- **文件的本质**
   <!-- - 在操作系统中，文件实际上是一个指针，只不过它指向的不是内存地址，而是一个外部存储地址（这里的外部存储可以是硬盘、U盘、甚至是网络）![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644807970497-5ab51c43-1cf8-445d-aed9-a2d1bb3c503f.png#averageHue=%23e4d5cc&clientId=u6524202e-5462-4&from=paste&height=557&id=u910a4273&name=image.png&originHeight=557&originWidth=993&originalType=binary&ratio=1&rotation=0&showTitle=false&size=41203&status=done&style=none&taskId=u908073e3-c9a4-4d7e-a1fd-2f950af7953&title=&width=993)
   - 当我们删除文件时，删除的实际上是指针，因此，无论删除多么大的文件，速度都非常快。![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808010809-7a7fc2ef-9906-42c4-a932-71d10cacb81c.png#averageHue=%23e2d3c9&clientId=u6524202e-5462-4&from=paste&height=515&id=u0dc04671&name=image.png&originHeight=515&originWidth=950&originalType=binary&ratio=1&rotation=0&showTitle=false&size=36330&status=done&style=none&taskId=ud2299d27-bf83-4c81-b452-a67dd84a815&title=&width=950) -->
- **文件的拷贝**
   - 如果你复制一个文件，是将该文件指针指向的内容进行复制，然后产生一个新文件指向新的内容

<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808042435-820b82ab-acc0-40ac-aeb4-49073dc9a8d9.png#averageHue=%23e9d6cb&clientId=u6524202e-5462-4&from=paste&height=441&id=uebf63719&name=image.png&originHeight=441&originWidth=1227&originalType=binary&ratio=1&rotation=0&showTitle=false&size=49212&status=done&style=none&taskId=uaa621987-1d80-431b-9a1b-6268e802072&title=&width=1227) -->

- **硬链接 hard link**
   - 硬链接的概念来自于 Unix 操作系统，它是指将一个文件A指针复制到另一个文件B指针中，文件B就是文件A的硬链接

<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808073997-dd859304-e5d0-4bff-833d-ba2b69dbc13c.png#averageHue=%23e5d6cd&clientId=u6524202e-5462-4&from=paste&height=558&id=u3a4cf0fa&name=image.png&originHeight=558&originWidth=1008&originalType=binary&ratio=1&rotation=0&showTitle=false&size=67276&status=done&style=none&taskId=ubaa96fa6-fae1-492d-8ea4-f2222da3956&title=&width=1008) -->
...
<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808145371-71f84f93-5074-4fc0-aed8-195005c4e478.png#averageHue=%23e4d5cb&clientId=u6524202e-5462-4&from=paste&height=561&id=ubddec51e&name=image.png&originHeight=561&originWidth=974&originalType=binary&ratio=1&rotation=0&showTitle=false&size=59521&status=done&style=none&taskId=u7aa8391a-cf92-4b72-ba52-50f79c877e5&title=&width=974) -->
...
<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808299356-95e19773-aef0-45d0-b9ae-6259f7a73af8.png#averageHue=%23bebebe&clientId=u6524202e-5462-4&from=paste&height=618&id=ue415973b&name=image.png&originHeight=618&originWidth=1185&originalType=binary&ratio=1&rotation=0&showTitle=false&size=51306&status=done&style=none&taskId=ua9ee46d2-2590-4072-abe0-e6c384e7749&title=&width=1185) -->
...
<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808358970-e237308d-f985-43e7-9541-10be310d02dc.png#averageHue=%23f8f8f8&clientId=u6524202e-5462-4&from=paste&height=645&id=ufebf5d38&name=image.png&originHeight=645&originWidth=986&originalType=binary&ratio=1&rotation=0&showTitle=false&size=61075&status=done&style=none&taskId=ub4645e05-d154-4347-a852-1a7f0440030&title=&width=986) -->

   - 从缓存的对应包中使用硬链接放置文件到相应包代码目录中

<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808377812-b3bf4607-3497-4b7c-bac4-a5b1ff7bba89.png#averageHue=%23f8f7f7&clientId=u6524202e-5462-4&from=paste&height=662&id=ue1afc393&name=image.png&originHeight=662&originWidth=1042&originalType=binary&ratio=1&rotation=0&showTitle=false&size=70519&status=done&style=none&taskId=ue1c0739f-ac99-4062-b144-f4cbca831bd&title=&width=1042) -->

   - 使用符号链接，将每个包的**直接依赖**放置到自己的目录中

<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808402673-4d631ed0-39d5-4f60-af52-f9e9f0edb755.png#averageHue=%23f8f7f7&clientId=u6524202e-5462-4&from=paste&height=662&id=u2b031e4b&name=image.png&originHeight=662&originWidth=1034&originalType=binary&ratio=1&rotation=0&showTitle=false&size=74772&status=done&style=none&taskId=u97b504d5-3103-4664-9fc0-65225727b79&title=&width=1034) -->
...
<!-- ![image.png](https://cdn.nlark.com/yuque/0/2022/png/2675710/1644808525939-cc3c6786-3383-489f-aab5-b1cfcd0900ec.png#averageHue=%23f8f8f8&clientId=u6524202e-5462-4&from=paste&height=674&id=u5f259374&name=image.png&originHeight=674&originWidth=1048&originalType=binary&ratio=1&rotation=0&showTitle=false&size=71630&status=done&style=none&taskId=uea7a1bf8-ed94-48f0-8c8c-4c94a5a0bc6&title=&width=1048) -->
